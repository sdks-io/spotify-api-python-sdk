...
| `tempo_confidence` | `float` | Optional | The confidence, from 0.0 to 1.0, of the reliability of the `tempo`.<br>**Constraints**: `>= 0`, `<= 1` |
...
| `time_signature_confidence` | `float` | Optional | The confidence, from 0.0 to 1.0, of the reliability of the `time_signature`.<br>**Constraints**: `>= 0`, `<= 1` |
...
| `key_confidence` | `float` | Optional | The confidence, from 0.0 to 1.0, of the reliability of the `key`.<br>**Constraints**: `>= 0`, `<= 1` |
